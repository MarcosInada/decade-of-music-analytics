...
![Auditória de volume](auditório.png) 
...
•	Fórmula do Sucesso: O gráfico de dispersão prova que gêneros com maior carga de Energia tendem a alcançar níveis mais altos de Popularidade. Metal e Hip-Hop destacam-se nesse quadrante de alto engajamento.
...
# Página 4: Auditoria de Volumes e Inventário
•	Escala de Dados: Com 18 bilhões de streams e 69 mil faixas, o projeto possui uma base estatística robusta para as tendências apresentadas.
...
•	Autor: Marcos Inada
•	Analista de Dados | Power BI | Insights de Mercado Pet 
